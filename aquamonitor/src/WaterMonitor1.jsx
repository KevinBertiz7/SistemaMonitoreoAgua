        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {history.length > 0 && (
            <div className="card" style={{ padding: 16, maxHeight: 260, overflow: "hidden", display: "flex", flexDirection: "column" }}>
              <div style={{ fontSize: 9, color: "#445566", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 10 }}>Historial de Lecturas</div>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11, fontFamily: "'JetBrains Mono',monospace" }}>
                  ...
                  <tbody>
                    {[...history].reverse().map((h, i) => (
                      <tr key={h.id} style={{ background: i === 0 ? "#0a1a2a" : "transparent" }}>
